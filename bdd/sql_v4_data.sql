...
--
-- Host: localhost:3306
-- Generation Time: Oct 02, 2023 at 05:47 PM
...
--
-- Table structure for table `suborigin`
--
...
--
-- Dumping data for table `suborigin`
--

INSERT INTO `suborigin` (`id_suborigin`, `label`, `display_name`) VALUES
(1, 'european', 'Européen'),
(2, 'african', 'Africain'),
(3, 'chinese', 'Chinois'),
...
--
-- Table structure for table `suborigindistributionbyorigin`
--
...
--
-- Dumping data for table `suborigindistributionbyorigin`
--
...
--
-- Table structure for table `system_species`
--
...
--
-- Dumping data for table `system_species`
--
...
--
-- Indexes for table `suborigin`
--
ALTER TABLE `suborigin`
  ADD PRIMARY KEY (`id_suborigin`);

--
-- Indexes for table `suborigindistributionbyorigin`
--
...
--
-- Indexes for table `system_species`
--
...
--
-- Constraints for table `suborigindistributionbyorigin`
--
ALTER TABLE `suborigindistributionbyorigin`
...
--
-- Constraints for table `system_species`
--
ALTER TABLE `system_species`
